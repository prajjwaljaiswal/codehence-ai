...
import dotsquaresLogo from "../assets/dots-logo.svg";
import dotsquaresLogoInk from "../assets/dots-logo-ink.svg";
      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            {/* Dotsquares wordmark slides left; "AI" reveals to the right */}
            <div className="relative flex items-center justify-center">
              {/* Logo wrapper that gently slides left */}
              <motion.div
                className="relative z-10"
                initial={{ opacity: 0, scale: 1, x: 0 }}
                animate={{ opacity: 1, scale: 1, x: -6 }}
              ...
              >
                ...
                <motion.img
                  src={dotsquaresLogo}
                  alt="Dotsquares"
                  className="brand-logo brand-logo-on-dark h-14 w-auto"
                  transition={{ repeat: Infinity, repeatType: "loop", ease: "linear", duration: 0.5 }}
                />
                <motion.img
                  src={dotsquaresLogoInk}
                  alt=""
                  aria-hidden="true"
                  className="brand-logo brand-logo-on-light h-14 w-auto"
                  transition={{ repeat: Infinity, repeatType: "loop", ease: "linear", duration: 0.5 }}
                />
              </motion.div>
              ...
              <motion.div
                ...
                animate={{ x: 8, opacity: 1, clipPath: "inset(0 0% 0 0)" }}
...
function BrandText() {
  return (
    <div className="text-5xl font-extrabold tracking-tight brand-text">
      <span className="brand-text-solid">AI</span>
      <span aria-hidden="true" className="brand-text-shimmer">AI</span>
    </div>
  );
}
